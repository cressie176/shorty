...
import createRedirectRoutes from '../routes/redirect-api.js';
import createRedirectBrowserRoutes from '../routes/redirect-browser.js';
...
export default class WebServer {
  ...
  constructor({ config, postgres, redirectService }: WebServerParams) {
    ...
    this.app.route('/r', createRedirectBrowserRoutes({ redirectService }));
  }
